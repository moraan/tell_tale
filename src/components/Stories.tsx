   ...
   return (
    <div>
      ...
      <div style={divStyle}>
        ...
        <img style={{ width: 800, height: 600 }} src={full_moon} alt="The Moon Shines on an Egg" />
      </div>
      <div style={divStyle}>
        <p>One Sunday morning, the warm sun came up and pop! Out of the egg came a tiny and very hungry caterpillar.</p>
        <img style={{ width: 800, height: 600 }} src={hatch} alt="Caterpillar Hatches" />
      </div>
      <div style={divStyle}>
        <p>He started to look for some food.</p>
        <img style={{ width: 800, height: 600 }} src={hungry} alt="a hungry caterpillar" />
      </div>
      <div style={divStyle}>
        <p>On Monday he ate through one apple. But he was still hungry.</p>
        <img style={{ width: 600, height: 600 }} src={apple} alt="caterpillar and an apple" />
      </div>
      <div style={divStyle}>
        <p>On Tuesday, he ate through two pears, but he was still hungry.</p>
        <img style={{ width: 800, height: 700 }} src={pears} alt="caterpillar and pears" />
      </div>
      <div style={divStyle}>
        <p>On Wednesday, he ate through three plums, but he was still hungry.</p>
        <img style={{ width: 800, height: 700 }} src={plums} alt="caterpillar and plums" />
      </div>
      <div style={divStyle}> 
        <p>On Thursday, he ate through four strawberries, but he was still hungry.</p>
        <img style={{ width: 1100, height: 600 }} src={strawberries} alt="caterpillar and strawberries" />
      </div>
      <div style={divStyle}>
        <p>On Friday, he ate through five oranges, but he was still hungry.</p>
        <img style={{ width: 800, height: 600 }} src={oranges} alt="oranges and caterpillar" />
      </div>
      <div style={divStyle}>
        <p>On Saturday he ate through one piece of chocolate cake, one ice-cream cone, one pickle, one slice of Swiss cheese, one slice of salami, one lollipop, one piece of cherry pie, one sausage, one cupcake, and one slice of watermelon. That night he had a stomachache!</p>
        ...
        <div style={imgContainerStyle}>
          ...
          <img style={{ width: 400, height: 550 }} src={lollipop} alt="lollipop" />
        </div>
        <div style={imgContainerStyle}>
          <img style={{ width: 400, height: 400 }} src={pie} alt="pie" />
          <img style={{ width: 400, height: 500 }} src={sausage} alt="sausage" />
          <img style={{ width: 400, height: 500 }} src={muffin} alt="cupcake" />
        </div>
        <img style={{ width: 600, height: 500 }} src={watermelon} alt="watermelon" />
      </div>
      <div style={divStyle}>
        <p>The next day was Sunday again. The caterpillar ate through one nice green leaf, and after that he felt much better.</p>
        <img style={{ width: 800, height: 600 }} src={leaf} alt="caterpillar and leaf" />
      </div>
      <div style={divStyle}>
        <p>Now he was not hungry anymore, and he was not a little caterpillar anymore. He was a big, fat caterpillar.</p>
        <img style={{ width: 900, height: 400 }} src={fat} alt="caterpillar is fat" />
      </div>
      <div style={divStyle}>
        <p>He built a small house around himself, called a Cocoon, And he stayed inside for more than two weeks.</p>
      ...
      <div style={divStyle}>
        ...
        <img style={{ width: 800, height: 600 }} src={butterfly} alt="butterfly" />
      </div>
    </div>
  );
};
